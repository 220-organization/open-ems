...
export function parseEssSelection(value) {
  ...
  if (s.startsWith(ESS_PREFIX_GRIDLAB)) return { provider: 'gridlab', id: s.slice(ESS_PREFIX_GRIDLAB.length) };
