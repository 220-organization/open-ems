  ...
  return (
    <div className="pf-body">
      <div className="pf-root">
        ...
        <aside className="pf-oss-github" aria-label={t('openSourceGithubAria')}>
          <a
            className="pf-oss-github-link"
            href={OPEN_EMS_GITHUB_URL}
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
              className="pf-oss-github-icon"
              viewBox="0 0 98 96"
              xmlns="http://www.w3.org/2000/svg"
              aria-hidden="true"
              focusable="false"
            ...
            <span className="pf-oss-github-text">{t('openSourceLink')}</span>
          </a>
        </aside>
