...
# EV driver GPS tracker (220-km.com -> open-ems marketplace heatmap).
EV_TRACKER_PROCESSING_ENABLED: bool = _env_bool("EV_TRACKER_PROCESSING_ENABLED", True)
EV_TRACKER_PROCESSING_INTERVAL_SEC: int = _env_int("EV_TRACKER_PROCESSING_INTERVAL_SEC", 600, 60, 3600)
EV_TRACKER_RAW_RETENTION_DAYS: int = _env_int("EV_TRACKER_RAW_RETENTION_DAYS", 7, 1, 30)
EV_TRACKER_SETTLE_MINUTES: int = _env_int("EV_TRACKER_SETTLE_MINUTES", 30, 5, 180)
EV_TRACKER_MAX_DAY_JUMP_KM: float = _env_float("EV_TRACKER_MAX_DAY_JUMP_KM", 2000.0, 100.0, 10_000.0)
EV_TRACKER_MAX_SPEED_KMH: float = _env_float("EV_TRACKER_MAX_SPEED_KMH", 350.0, 50.0, 1000.0)
EV_TRACKER_STAY_RADIUS_M: float = _env_float("EV_TRACKER_STAY_RADIUS_M", 300.0, 50.0, 2000.0)
EV_TRACKER_STAY_MIN_MINUTES: int = _env_int("EV_TRACKER_STAY_MIN_MINUTES", 10, 1, 120)
EV_TRACKER_MIN_TRIP_KM: float = _env_float("EV_TRACKER_MIN_TRIP_KM", 20.0, 1.0, 500.0)
EV_TRACKER_CHARGE_STATION_RADIUS_M: float = _env_float("EV_TRACKER_CHARGE_STATION_RADIUS_M", 150.0, 50.0, 1000.0)
EV_TRACKER_OPEN_DATA_CACHE_SEC: int = _env_int("EV_TRACKER_OPEN_DATA_CACHE_SEC", 300, 30, 3600)
